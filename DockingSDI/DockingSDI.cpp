// DockingSDI.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CDockingSDIApp, CBCGPWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDockingSDIApp::OnAppAbout)
...
// CDockingSDIApp construction

CDockingSDIApp::CDockingSDIApp()
{
...
// The one and only CDockingSDIApp object

CDockingSDIApp theApp;
CBCGPOccManager theOccManager;


// CDockingSDIApp initialization

BOOL CDockingSDIApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDockingSDIDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CDockingSDIView));
	if (!pDocTemplate)
		return FALSE;
...
// CDockingSDIApp message handlers

int CDockingSDIApp::ExitInstance()
{
...
void CDockingSDIApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CDockingSDIApp::PreLoadState()
{
